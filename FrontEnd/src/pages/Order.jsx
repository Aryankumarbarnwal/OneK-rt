                        ...
                        py-[10px] px-[20px] rounded-2xl relative'>
                                ...
                                <div className='flex items-start justify-center flex-col gap-[5px]'>
                                    ...
                                    <div className='flex items-center gap-[8px] md:gap-[20px]'>
                                        <p className='md:text-[18px] text-[12px] text-[#aaf4e7]'>{currency}
                                            {item.price}</p>
                                    ...
                                    <div className='flex items-center'>
                                        ...
                                        className='text-[#e4fbff] pl-[10px] md:text-[16px] text-[11px]'>
                                        {new Date(item.date).toDateString()}</span></p>
                                    </div>
                                    <div className='flex items-center'>
                                        <p className='md:text-[16px] text-[12px] text-[#aaf4e7]'>
                                            Payment Method :{item.paymentMethod}</p>
                                        </div>
                                    ...
                                    <div className='absolute md:right-[5%] right-[1%] md:top-[40%] top-[70%]'>
                                        ...
                                        text-[#f3f9fc] text-[12px] md:text-[16px] cursor-pointer 
