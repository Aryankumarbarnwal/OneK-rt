...
function NewLetterBox() {
  ...
  return (
    ...
    flex items-center justify-start gap-[10px] flex-col'>
        ...
        font-semibold px-[20px]'> Subscribe Now and enjoy exclusive savings, special deals, and early access to new collections.</p>
        ...
        mt-[20px] gap-[20px] px-[20px]'>
            ...
            bg-slate-300 w-[600px] max-w-[60%] h-[40px] px-[20px] rounded-lg 
            shadow-sm shadow-black' required/>

            <button type='submit' className='text-[15px] md:text-[16px] px-[10px] md:px-[30px]
            py-[12px] md:py-[10px] hover:bg-slate-500 cursor-pointer bg-[#2d3030c9] 
            text-white flex items-center justify-center gap-[20px] border-[1px] border-[#80808049]
