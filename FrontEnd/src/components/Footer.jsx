        ...
        flex items-center justify-center md:px-[50px] px-[5px] '>
                <div className='md:w-[30%] w-[35%] h-[100%] flex  justify-center flex-col gap-[5px]'>
                    <div className='flex items-start justify-start gap-[5px] mt-[10px] md:mt-[40px]'>
                        <img src="vcart logo.png" alt="" className='md:w-[40px] md:h-[40px] w-[30px] h-[30px]' />
                        <p className='text-[19px] md:-text-[20px] text-[black]'>OneK@rt</p>

                    </div>
                    <p className='text-[15px] text-[#1e2223] hidden md:block'>
                        OneK@rt is your all-in-one online shopping destination,
                        offering top-quality products, unbeatable deals,
                        and fast delivery-all backed by trusted service
                        designed to make your life easier every day.
                    </p>
                    <p className='text-[15px] text-[#1e2223] flex md:hidden'>
                        Fast. Easy. Reliable. OneK@rt Shopping
                    </p>
                ...
                <div className='md:w-[25%] w-[40%] h-[100%] flex items-center justify-center flex-col text-center'>
                    ...
                    <ul>
                        <li className='text-[15px] text-[#1e2223] hidden md:block 
                        cursor-pointer'>+91-xxxxx99900</li>
                        <li className='text-[15px] text-[#1e2223]  
                        cursor-pointer'>Contact@oneKart.com</li>
                        <li className='text-[15px] text-[#1e2223] hidden md:block 
                        cursor-pointer'>+1-123-456-7890</li>
                        <li className='text-[15px] text-[#1e2223] 
                        cursor-pointer'>admin@onekart.com</li>
                    </ul>
                </div>
            </div>
            <div className='w-[100%] h-[1px] bg-slate-400 '></div>
            <div className='w-[100%] h-[5.3vh] bg-[#dbfcfcec] flex items-center justify-center'>Copyright 2025@oneK@rt.com-All Rights Reserved
            </div>
        </div>
    )
}
