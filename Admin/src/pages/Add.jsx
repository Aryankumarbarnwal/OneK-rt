...
function Add() {
  ...
  return (
    ...
    fixed  mt-[72px]'>
      ...
      overflow-x-hidden absolute right-0 bottom-[10%]'>
        <form action="" onSubmit={handleAddProduct} className='w-[100%] md-w-[90%] h-[100%] mt-[70px]
        flex flex-col gap-[30px] py-[60px] px-[30px] md:px-[60px]'>
          <div className='w-[400px] h-[50px] text-[25px] md-text-[40px]
           text-white'>Add Product Page</div>
          ...
          justify-center flex-col mt-[20px] gap-[10px] '>
            ...
            <div className='w-[100%] h-[100%] flex items-center justify-start '>
              ...
              <label htmlFor="image2" className='w-[65px] h-[65px] md:w-[100px] 
              md:h-[100px] cursor-pointer hover:border-[#46d1f7]'>
          ...
          <div className='w-[80%] flex items-center gap-[10px] flex-wrap'>
            <div className='md:w-[30%] w-[100%] flex itmes-start sm:justify-center flex-col 
            gap-[10px] '>
              <p className='text-[20px] md:text-[25px] font-semibold
              w-[100%] '>Product Category</p>
              <select name="" id="" className='bg-slate-600 w-[60%] px-[10px] py-[7px] 
              rounded-lg hover:border-[#46d1f7]
              border-[2px]' onChange={(e)=>setCategory(e.target.value)} value={category}>
            ...
            gap-[10px] '>
              <p className='text-[20px] md:text-[25px] font-semibold
              w-[100%] '>Sub-Category</p>
              <select name="" id="" className='bg-slate-600 w-[60%] px-[10px] py-[7px] 
              rounded-lg hover:border-[#46d1f7]
              border-[2px]' onChange={(e)=>setSubCategory(e.target.value)} value={subCategory}>
          ...
          gap-[10 px]py-[10px] md:py-[0px]'>
            <p className='text-[20px] md:text-[25px] font-semibold'>Product Size</p>

            <div className='flex items-center justify-start gap-[15px] flex-wrap'>
              <div className={`px-[20px] py-[7px] rounded-lg bg-slate-600 text-[18px]
          ...
          <div className='w-[80%] flex items-center justify-start gap-[10px] mt-[20px]'>
                ...
                font-semibold'>Add to BestSeller </label>
          </div>
          ...
          active:text-white active:border-[2px] border-white cursor-pointer'>
